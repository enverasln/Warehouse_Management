package tr.com.cetinkaya.data_remote.models.order_transaction
...
data class OrderTransactionResponseModel (
...
fun OrderTransactionResponseModel.toDataModel(): OrderTransactionDataModel = OrderTransactionDataModel(
    id = this.id,
    ...
    dataOrigin = DataOrigin.Remote,
    userCode = 0
)

fun List<OrderTransactionResponseModel>.toDataModel(): List<OrderTransactionDataModel> = this.map { it.toDataModel() }
