...
interface StockTransactionService {
    ...
    @GET(GET_STOCK_TRANSACTION_DOCUMENT_BY_DOCUMENT_NUMBER)
    suspend fun getStockTransactionDocumentByPaperNumberAndCurrentCode(
        @Query("evrakNoSeri") documentSeries: String,
        @Query("evrakNoSira") documentNumber: Int,
        @Query("stokHareketTipi") stockTransactionType: Byte,
        @Query("stokHareketCinsi") stockTransactionKind: Byte,
        @Query("stokHareketEvrakTipi") documentType: Byte,
        @Query("stokHareketIslemTipi") isNormalOrReturn: Byte
    ): Response<GetStockTransactionDocumentResponseModel>

    @GET(GET_STOCK_TRANSACTION_DOCUMENT_BY_PAPER_NUMBER)
    suspend fun getStockTransactionDocumentByPaperNumberAndCurrentCode(
        @Query("evrakNoSeri") documentSeries: String,
        @Query("evrakNoSira") documentNumber: Int,
        @Query("belgeNo") paperNumber: String,
        @Query("cariKod") currentCode: String,
        @Query("stokHareketTipi") stockTransactionType: Byte,
        @Query("stokHareketCinsi") stockTransactionKind: Byte,
        @Query("stokHareketEvrakTipi") documentType: Byte,
        @Query("stokHareketIslemTipi") isNormalOrReturn: Byte
    ...
    companion object {
        ...
        private const val GET_STOCK_TRANSACTION_DOCUMENT_BY_DOCUMENT_NUMBER = "depo-service/stok-hareketleri/get-stok-hareket-evragi-by-evrak-no"
        private const val GET_STOCK_TRANSACTION_DOCUMENT_BY_PAPER_NUMBER = "depo-service/stok-hareketleri/get-stok-hareket-evragi-by-evrak-no"
