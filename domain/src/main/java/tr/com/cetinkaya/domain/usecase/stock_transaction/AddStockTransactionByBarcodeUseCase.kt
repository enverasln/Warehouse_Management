...
class AddStockTransactionByBarcodeUseCase(
    configuration: Configuration, private val orderTransactionRepository: StockTransactionRepository
) : UseCase<AddStockTransactionByBarcodeUseCase.Request, AddStockTransactionByBarcodeUseCase.Response>(configuration) {
