...
interface DocumentSyncRepository {
    ...
    suspend fun markTransferredDocumentSynced(transferredDocumentTypes: TransferredDocumentType, documentSeries: String, documentNumber: Int)
    ...
    suspend fun changeTransferredDocumentNumber(
        transferredDocumentTypes: TransferredDocumentType, documentSeries: String, oldDocumentNumber: Int, newDocumentNumber: Int
